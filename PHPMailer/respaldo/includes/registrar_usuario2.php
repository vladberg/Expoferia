...
echo '<script language=Javascript> location.href="../panel/registrar_usuario.php"</script>';
}else {
...
$nuevo_login=mysql_query("insert into login values (0,'$email','$claveA',0,1,'$id',0)");

echo '<script> alert (".:: Los datos del usuario han registrados ::.") </script>';
