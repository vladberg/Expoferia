...
//Registrando usuario
///////////////////////////
$nuevo_usuario=mysql_query("insert into registro_conferencias(nombre,empresa,puesto,email,telefono,tipoconferencia,conferencias,fecha,hora) values ('$nombres','$empresa','$puesto','$email','$telefono','$tipoconferencia','$conferencias','$fecha','$hora')");
$id=mysql_insert_id();
...
echo '<script> alert (".:: Gracias por registrarse a las conferencias ::.") </script>';
