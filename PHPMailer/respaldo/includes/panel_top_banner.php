...
<link rel="stylesheet" type="text/css" href="js/sliderman.css" />
<!-- /sliderman.js -->


<table cellpadding="0" cellspacing="0" border="0"><tr><td style="padding:0px 0px 20px 0px;">
...
<a href="<?php echo $rulimagen ?>" target="_self">
         <img src="<?php echo $rimagen.$imagen; ?>" width="500" height="350" alt="<?php echo $nimagen; ?>" title="<?php echo $nimagen; ?>" /></a>
...
?>
         ...
         <img src="<?php echo $rimagen.$imagen; ?>" width="500" height="350" alt="<?php echo $nimagen; ?>" title="<?php echo $nimagen; ?>" />
<?
...
<div id="SliderNameNavigation_2"></div>
	...
	var demoSlider_2 = Sliderman.slider({container: 'SliderName_2', width: 500, height: 350, effects: effectsDemo2,
	display: {
	autoplay: 6000,
