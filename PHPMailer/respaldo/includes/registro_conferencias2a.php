...
$idconferencia=$_POST['miseleccion'];
$GRUPO=$_POST['cf'];
//Validar si el correo se encuentra registrado
$validar=mysql_query("select email from registro_conferencias where email='$email'");
...
//Registrando usuario
///////////////////////////
$nuevo_usuario=mysql_query("insert into registro_conferencias(nombre,empresa,puesto,email,telefono,tipoconferencia,conferencias,fecha,hora) values ('$nombres','$empresa','$ocupacion','$email','$telefono','$tipoconferencia','$conferencias','$fecha','$hora')");
$id=mysql_insert_id();
...
$conf=mysql_query("insert into regconf_tipos (idreg,conferencia,fecha,hora) values ('$id','$GRUPO[$i]','$fecha','$hora')");


echo ("insert into regconf_tipos (idreg,conferencia,fecha,hora) values ('$id','$GRUPO[$i]','$fecha','$hora')");
...
//$para  = 'comunicacion@canacomerida.com'; // Email destino
//// Asunto
