...
<div id="SliderName_2" class="SliderName_2">
 ...
 $rimagen="images/slider/";
	...
	//Campos excepción en menus web indica banner principal en expositores
	$sqlimag=mysql_query("select * from img_menus_web where status=1 and idmenu=$idmenu and excepcion=1");
