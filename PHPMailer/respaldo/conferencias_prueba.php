...
var opciones="toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, width=660, height=550, top=90, left=390";
...
$d="2015-10-15";
$d16=mysql_query("select * from actividades where fecha='$d' and conferencia=1 order by hora asc");
...
//consulta para obtener actividades
$d="2015-10-16";
$d17=mysql_query("select * from actividades where fecha='$d' and conferencia=1 order by hora asc");
...
<tr><td align="justify" bgcolor="<?php echo $bgcolor?>">
<div style="width:140; margin-left:3px">
<a class="<?php echo $colorfont ?>" href="#" onclick="javascript:abrirventana('detalle_conferencia.php?ide=<?php echo $tidactividad?>')" ><?php echo utf8_decode($tactividad)?>&nbsp;&nbsp;<?php echo $thora?></a>
</div></td>
...
//consulta para obtener actividades
$d="2015-10-17";
$d18=mysql_query("select * from actividades where fecha='$d' and conferencia=1 order by hora asc");
...
//consulta para obtener actividades
$d="2015-10-18";
$d19=mysql_query("select * from actividades where fecha='$d' and conferencia=1 order by hora asc");
