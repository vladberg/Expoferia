...
$id_concurso=$_GET['idcon'];
//Obteniendo datos del concurso

$lista=mysql_query("select * from concurso where idconcurso='$id_concurso'");
$vlista=mysql_fetch_array($lista);
$titulo=$vlista['titulo'];
$fechaini=$vlista['fechainicial'];
$fechafin=$vlista['fechafinal'];
$bases=$vlista['bases'];
$premios=$vlista['premios'];
...
<title>.:: <?php echo $panel_edconcursos?> ::.</title>
...
<br /><br /><br /><br /><br /><br /><br /><br />
  ...
  <br />
<!-- Contenido-->
                      <form action="../includes/editar_concurso2.php" method="post" enctype="multipart/form-data" name="fvalida" id="fvalida">
                          <table width="770" border="0" align="center" style="font-size:12px">
                            <tr>
                              <td colspan="3"  align="center"><br /><img src="../images/separador.gif" /></td>
                            </tr>
                            <tr>
                              <td colspan="3"  align="center"><h3 style="font-size:18px">EDITAR CONCURSO</h3></td>
                            </tr>
                            <tr>
                              <td  align="right">&nbsp;</td>
                              <td align="right">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td width="281" align="left"><input type="text" name="titulo" id="titulo"  size="45" / value="<?php echo utf8_decode($titulo)?>">
                              <input type="hidden" name="titulo2" id="titulo2"  size="45" / value="<?php echo utf8_decode($titulo)?>" /></td>
                            </tr>
                            ...
                            <tr>
                              ...
                              <td align="left">
                               ...
                               <input type="text" name="datepicker" id="datepicker" readonly="readonly" size="12"  value="<?php echo $formfechaini?>"/>
                               **
                               <input type="hidden" name="idc" id="idc"  size="45" / value="<?php echo $id_concurso?>" /></td>
                            </tr>
                            <tr>
                              <td align="right" valign="top">*Fecha final:</td>
                              <td align="left">
                             
                               <input type="text" name="datepicker2" id="datepicker2" readonly="readonly" size="12" value="<?php echo $formfechafin?>"/>
                               **</td>
                            </tr>
                            <tr>
                              <td align="right" valign="top">*Bases:</td>
                              <td align="left"><textarea name="bases" id="bases" cols="35" rows="5" style="resize:none"><?php echo utf8_decode($bases)?></textarea><br />
                              <span style="font-size:10px; color:#0000FF">M&iacute;nimo 10 caracteres</span></td>
                            </tr>
                            <tr>
                              <td align="right" valign="top">*Premios:</td>
                              <td align="left" valign="top"><textarea name="premios" id="premios" cols="35" rows="5" style="resize:none"><?php echo utf8_decode($premios)?></textarea><br />
                              <span style="font-size:10px; color:#0000FF">M&iacute;nimo 10 caracteres</span></td>
                            </tr>
                            <tr>
