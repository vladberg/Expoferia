...
//Resultados consulta
 $cabecera = array("Nombre(s)","Apellido(s)","Colonia", "Ciudad", "Estado","País", "email","celular");


while($vlista=mysql_fetch_assoc($sconsulta)){
$datos = array(utf8_decode($vlista['nombres']),utf8_decode($vlista['apellidopaterno']), utf8_decode($vlista['colonia']),utf8_decode($vlista['ciudad']),utf8_decode($vlista['estado']),utf8_decode($vlista['pais']),$vlista['email'],$vlista['celular']);
