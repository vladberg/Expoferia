...
<!------>
  ...
  <a href="registrar_actividad.php" class="link_ad">Registrar</a>&nbsp;&nbsp;|&nbsp;&nbsp;
 ...
 <tr>
    ...
    <form action="actividades.php" method="get" name="consulta" target="_self">
<span style="font-size:12px; font-weight:bold">Actividad</span>
...
<tr> <td width="411" align="center"><strong>ACTIVIDADES REGISTRADAS</strong></td> 
...
if ($formatop==""){
$criterio=	" where status=1 and conferencia=0 order by idactividad desc";
}else{
$criterio=	" where actividad like '%$formatop%' and status=1 and conferencia=0 order by idactividad desc";
}
...
<?php /*?>    <td width="67" align="center" valign="top"><?php echo $status ?></td><?php */?>
    <td width="157" align="center" valign="top">
      <a  href="editar_actividad.php?idact=<?php echo $a_idactividad?>" class="link_ad">
        Editar</a>&nbsp;&nbsp;&nbsp;| &nbsp;&nbsp; <a  href="../includes/eliminar_actividad.php?idact=<?php echo $a_idactividad?>" class="link_ad">Eliminar</a></td>
  </tr>
