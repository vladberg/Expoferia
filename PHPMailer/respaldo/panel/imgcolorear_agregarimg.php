...
$mypathPerfil = "../images/colorear/".$purl;
$myruta = "images/colorear/".$purl;
...
$guarda=mysql_query("INSERT INTO `img_colorear`  VALUES (0,'$name', 1)");
...
echo '<script language=Javascript> location.href="imgcolorear_agregarimg.php" </script>';
$tipo="";
...
<br /><br /><br /><br /><br /><br /><br /><br />
 ...
 <!-- Contenido-->
                      ...
                      <tr>
                        ...
                        <td height="52" align="center">GALERÍA:  <b><?php echo $nom ?></b></td>
...
<form name="subirimagen" id="subirimagen" action="imgcolorear_agregarimg.php" method="post" enctype="multipart/form-data" onSubmit="return validacion()">
...
$consulta1="select * from img_colorear where status=1 order by idimgc desc";
...
$sqlconsulta=mysql_query("select * from img_colorear where status=1 order by idimgc desc LIMIT $limitInf,$tamPag ");
$rutaim="../images/colorear/";
...
<hr width="100px" />    
 <?php /*?> <a href="#"  onclick="javascript:cambiostatus('../includes/url_banner_galeria.php?idbanner=<?php echo $idimg?>')" class="link_ad">- Actualizar url</a><br /><?php */?>
                                ...
                                <?php /*?>  <a class="link_ad" href="../includes/cambio_status.php?dp=<?php echo $dp?>&pid=<?php echo $idimg?>&idm=<?php echo $idmenu_img?> "><span style="color:#00F">- <?php echo $P_destaque ?></span></a><?php */?>
                                 <br />
                                 <a class="link_ad" href="../includes/eliminar_imagen_colorear.php?pid=<?php echo $idimg?>"><span style="color:#00F">- Eliminar</span></a>
                             </td>
                              </tr>
                              <tr>
                                <td colspan="3"><br />
...
?>
                      ...
                      <tr>
                       ...
                       <tr>
                        <td height="3" align="left"><span style="font-size:12px; color:#F00">-  Medidas recomendadas:   800px de ancho por 750px de alto<br />
