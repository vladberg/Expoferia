...
//Todos salones / Todas las empresas
if ($idsalon==0 && $empresa==""){
$criterio="order by idstand_emp desc";
$v=0;//Indica si se muestra la columna salón
$leyenda=" EN TODOS LOS SALONES";
}

//Todos salones / Por empresa x
if ($idsalon==0 && $empresa<>""){
$criterio="where empresa like '%$empresa%' order by idstand_emp desc";
$v=0;//Indica si se muestra la columna salón
$leyenda=" EN TODOS LOS SALONES";
}
...
//Por salón x/ Todas
if ($idsalon<>0 && $empresa==""){
$criterio="where salones.idsalon='$idsalon' order by idstand_emp desc";
	$v=1;
...
//Por salón x/ por empresa x
if ($idsalon<>0 && $empresa<>""){
$criterio="where salones.idsalon='$idsalon' and empresa like '%$empresa%' order by idstand_emp desc";
	$v=1;
	//Validando nombre de salón para encabezado
	if ($idsalon==1){
	$leyenda=" SAL&Oacute;N CHICHEN ITZ&Aacute;";
...
?>
  ...
  <tr><td height="26" align="center" class="bordeado">
  ...
  <form action="registro_stands.php" method="get">
    ...
    <select name="salones" id="salones">
   ...
   <span class="texto_panel"> Empresa:</span>
