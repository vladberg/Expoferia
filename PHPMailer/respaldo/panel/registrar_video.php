...
<head>
<title>.:: <?php echo $panel_registrarvideos?> ::.</title>
...
<br /><br /><br /><br /><br /><br /><br /><br />
  ...
  <br />
<!-- Contenido-->
                      <form action="../includes/registrar_video2.php" method="post" enctype="multipart/form-data" name="fvalida" id="fvalida">
                          <table width="770" border="0" align="center" style="font-size:12px">
                            <tr>
                              <td colspan="3"  align="center"><br /><img src="../images/separador.gif" /></td>
                            </tr>
                            <tr>
                              <td colspan="3"  align="center"><h3 style="font-size:18px">REGISTRO DE VIDEO YOUTUBE</h3></td>
                            </tr>
                            <tr>
                              <td  align="right">&nbsp;</td>
                              <td align="right">&nbsp;</td>
                            ...
                            <tr>
                              <td align="right" valign="top">*C&oacute;digo:</td>
                              <td align="right" valign="top"><textarea name="codigo" id="codigo" cols="35" rows="5" style="resize:none"></textarea><br />
                              <span style="font-size:10px; color:#0000FF">Medidas recomendadas: 550px de ancho por 330px de alto</span></td>
                            </tr>
                            <tr>
                              <td height="68" align="right" valign="top">*Clave video:</td>
                              <td height="68" align="right" valign="top"><input type="text" name="clavev" id="clavev"  size="45" />
