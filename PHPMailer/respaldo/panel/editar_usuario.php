...
$datos_usuario=mysql_query("select nombres,apellidopaterno,apellidomaterno,direccion,telefono,celular,usuario from usuarios inner join login on usuarios.idusuario=login.idusuario where usuarios.idusuario='$ids'");
...
<head>
<title>.:: <?php echo $panel_usuariosE?> ::.</title>
...
<br /><br /><br /><br /><br /><br /><br /><br />
  ...
  <br />
<!-- Contenido-->
                      <form action="../includes/editar_usuario2.php" method="post" enctype="multipart/form-data" name="fvalida" id="fvalida">
                          <table width="770" border="0" align="center" style="font-size:12px">
                            ...
                            <tr>
                              ...
                              <td width="281" align="right"><input type="hidden" name="idusuariop" id="idusuariop" size="45" value="<?php echo $ids?>"/>                                <input type="text" name="nombres" id="nombres"  size="45" value="<?php echo utf8_decode($minombre)?>"/></td>
                            </tr>
                            <tr>
                              <td align="right">*Apellido Paterno:</td>
                              <td align="right"><input type="text" name="apellidos" id="apellidos" size="45" value="<?php echo utf8_decode($apellidopatusu)?>"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td align="right"><input type="text" name="direccion" id="direccion" size="45" value="<?php echo utf8_decode($direccionusu)?>"/></td>
                            </tr>
                            
                            <tr>
                              <td align="right" valign="top">Tel&eacute;fono:</td>
                              <td align="right"><input name="telefono" type="text" id="telefono" size="45" value="<?php echo $telefonousu?>"/>                              <br />
                            ...
                            <tr>
                              ...
                              <td align="right"><input name="celular" type="text" id="celular" size="45" value="<?php echo $celularusu?>"/>
                            ...
                            <tr>
                              ...
                              <td align="right"><input type="hidden" name="email2" id="email2" size="45" value="<?php echo $emailusu?>"/>
                                <input type="text" name="email" id="email" size="45" value="<?php echo $emailusu?>"/>
                                <br />
