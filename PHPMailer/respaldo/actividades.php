...
<meta charset="iso-8859-1">
 <!--Palabras tag-->
 <meta name="description" content="La Cámara de Comercio te invita a a disfrutar del jueves 15 al domingo 18 de octubre de 2015 del evento comercial más grande e importante del sureste, en todos los salones de exposición del Centro de Convenciones Yucatan Siglo XXI. Conoces nuestras actividades"/>
 
 <?php $b="expocomercio, comercio, Mérida, feria, exponer, expositores, productos, centro de convenciones, convenciones, siglo XXI, Yucatán, Canaco, familia, visita, compras, negocio, escaparate, ventas, stands, Cámara, servicios, turismo, exposiciones, Centro de Convenciones siglo XXI, Salón Uxmal, Salón Chichen Iztá, Salón Ek Balam, Expocomercio 2015 Mérida, comerciantes, negocios, medios, publicidad, promocionar, patrocinadores, coca cola, dunosusa, Gobierno del Estado de Yucatán, Infinitum, Osorio, Telcel"?>
...
<table width="900" height="448" cellspacing="0" style="margin-top:-40px;" background="images/calendario_actividades.jpg" >
<tr>
<td width="168" height="408" align="center">
<!-- Jueves 16-->
...
$d="2015-10-15";
$d16=mysql_query("select * from actividades where fecha='$d' and conferencia=0 and status=1 order by idactividad asc");
...
<tr><td align="justify"><a class="eventos" href="#" onclick="javascript:abrirventana('detalle_actividad.php?ide=<?php echo $tidactividad?>')" ><?php echo utf8_decode($tactividad)?></a>&nbsp;<span class="hora_actividades">&nbsp;/<?php echo $thora?></span></td>
...
//consulta para obtener actividades
$d="2015-10-16";
$d17=mysql_query("select * from actividades where fecha='$d' and conferencia=0 and status=1 order by idactividad asc");
...
<tr><td><a class="eventos" href="#" onclick="javascript:abrirventana('detalle_actividad.php?ide=<?php echo $tidactividad?>')" ><?php echo utf8_decode($tactividad)?></a>&nbsp;<span class="hora_actividades">&nbsp;/<?php echo $thora?></span></td>
...
//consulta para obtener actividades
$d="2015-10-17";
$d18=mysql_query("select * from actividades where fecha='$d' and conferencia=0 and status=1 order by idactividad asc");
...
//consulta para obtener actividades
$d="2015-10-18";
$d19=mysql_query("select * from actividades where fecha='$d' and conferencia=0 and status=1 order by idactividad asc");
...
<!--Termina Domingo 19-->
    ...
    <td width="230" valign="top" align="justify" height="408">  </td>  </tr>
<tr>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="https://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>   <!--Termina twitter -->
  ...
  <div style=" height:24px; margin-top:780px"></div>
