...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Expo Feria del Comercio</title>
  ...
  <link rel="shortcut icon" href="img/logoexpo.png">
...
<nav class="navbar navbar-default">
  ...
  <div class="container">
      ...
      <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php" STYLE="color:#007ac3">EXPOFERIA DEL COMERCIO</a>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <li><a href="index.php">Inicio</a></li>
            ...
            <li><a href="galeria.php" style="color:#ED2024">Galeria</a></li>

            <!--<li><a href="directorio.php" style="color:#ED2024">Directorio</a></li>-->

            <li><a href="contacto.php" style="color:#ED2024">Contacto</a></li>
    ...
    <div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 500px; overflow: hidden; visibility: hidden;">
      ...
      ?>
            ...
            <div data-p="225.00" style="display: none;">
                ...
                <a href="#"><img data-u="image" class="img-responsive img-thumbnail" src="banners/<?php echo $row[2];?>" /></a>
...
<section class="bg-primary">
  ...
  <article class="container text-center">
    ...
    <div class="col-sm-3 seccion-30">
      ...
      <a href="tarimas.php" type="button" class="btn btn-primary">Tarima</a>
...
<footer class="bg-success"> 
  ...
  <article class="container text-center ">
   ...
   <p class="text-center"> <h2 style="color:#ffffff">Siguenos: </h2><a href="https://www.facebook.com/ExpoFeriaDeComercio/" target="_blank" ><img src="img/facebook_icon_white.png"  class="img-responsive center-block" width="7%"></a> </p>
